						...
						<div class="row">
							<div class="col-sm-6 col-md-3">
								<div class="form-group">
									Product Id <input type="text" class="form-control" name="id" value="${id }" readonly style="background-color: rgba(50, 50, 50, 0.2);" />
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									Name <input type="text"  class="form-control" name="name" value="${item.getName() }"/>
								</div>
							</div>
						</div>
						<!-- /.row -->
							...
							<div class="col-sm-6 col-md-3">
								<div class="form-group">
									Price <input type="text"
										class="form-control" name="price" value="${item.getPrice() }">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									description <input type="text"
										class="form-control" name="description" value="${item.getDescription() }">
								</div>
							</div>
						</div>
						<!-- /.row -->
							...
							<div class="col-sm-6 col-md-3">
								<div class="form-group">
									categoryId <input type="text"
										class="form-control" name="categoryId" value="${item.getCategoryId() }">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									image <input type="text"
										class="form-control" name="image" value="${item.getImage() }">
								</div>
							</div>				
					...
					<div class="box-footer">
						...
						<div class="pull-right">
							<button type="submit" class="btn btn-primary">
								Edit<i class="fa fa-chevron-right"></i>
							</button>
						</div>
					</div>
					</form>
